                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="recipient_address_delivery" style="display: none;">
                            ...
                            <?php /* Закоментовано поля Floor, Apartment - не потрібні для кур'єрської доставки
                            <div class="form-group">
...
<script type="text/javascript">
    var meest2OrderFormUrls = {
        ...
        order_shipping_data: <?php echo !empty($order_shipping_data) ? json_encode($order_shipping_data) : 'null'; ?>
    };
</script>
